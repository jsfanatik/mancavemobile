...
import imgOne from '../assets/screenshots/dec-2023-shots/menu_planner_two.png';
import imgTwo from '../assets/screenshots/dec-2023-shots/menu_planner_three.png';
...
export default function Example() {
  return (
    <div className="overflow-hidden bg-white py-24 sm:py-32 relative">
      ...
      <Link to="/pme/search" className="fixed left-12 bg-red-500 text-white p-4 rounded-full shadow-lg top-1/2 transform -translate-y-1/2">

...
export default function Example() {
  return (
    <div className="overflow-hidden bg-white py-24 sm:py-32">
      ...
      <Link to="/pme/planner" className="fixed left-4 bottom-4 bg-red-500 text-white p-4 rounded-full shadow-lg">
        <ChevronLeftIcon className="h-6 w-6" />
      </Link>
      <Link to="/pme/favorites" className="fixed right-4 bottom-4 bg-red-500 text-white p-4 rounded-full shadow-lg">
